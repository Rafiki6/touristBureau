document.addEventListener("DOMContentLoaded", () => {
    ...
    function select(id, list) {
        ...
        e.selectedIndex = 0;//SELECT FIRST ITEMAS DEFAULT

        for (let i = 0; i < list.length; i++) {
            const o = document.createElement("option");// BY PASSING TAG TO CREATE A TAG USING JAVASCRIPTS
            o.innerText = list[i];
            e.appendChild(o);
        }
